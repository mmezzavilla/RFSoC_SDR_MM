...
#
# Generated by Vivado on Fri Sep 27 00:53:22 EDT 2024
...
#
#    "/home/wirelesslab914/ali/sounder_rfsoc/vivado/sounder_fr3_if_ddr4_mimo_4x2_v2/project.srcs/constrs_1/imports/new/rfsoc4x2.xdc"
#    "/home/wirelesslab914/ali/sounder_rfsoc/vivado/sounder_fr3_if_ddr4_mimo_4x2_v2/project.srcs/utils_1/imports/synth_1/system_bd_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/wirelesslab914/ali/sounder_rfsoc/vivado/sounder_fr3_if_ddr4_4x2_v2/project.srcs/utils_1/imports/synth_1/system_bd_wrapper.dcp"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/project.srcs/constrs_1/imports/new/rfsoc4x2.xdc"]"\
 "[file normalize "$origin_dir/project.srcs/utils_1/imports/synth_1/system_bd_wrapper.dcp"]"\
  ...
  set files [list \
 "[file normalize "$origin_dir/../sounder_fr3_if_ddr4_4x2_v2/project.srcs/utils_1/imports/synth_1/system_bd_wrapper.dcp"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set_property -name "ip_output_repo" -value "/home/wirelesslab914/D:/temp/mobile-ch1_4x2_v1/sounder_fr3_if_ddr4_4x2/${_xil_proj_name_}.cache/ip" -objects $obj
...
set file "[file normalize "$origin_dir/project.srcs/constrs_1/imports/new/rfsoc4x2.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/rfsoc4x2.xdc"
...
set file "$origin_dir/../sounder_fr3_if_ddr4_4x2_v2/project.srcs/utils_1/imports/synth_1/system_bd_wrapper.dcp"
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu48dr-ffvg1517-2-e -flow {Vivado Synthesis 2022} -strategy "Flow_PerfOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set_property -name "incremental_checkpoint" -value "/home/wirelesslab914/ali/sounder_rfsoc/vivado/sounder_fr3_if_ddr4_4x2_v2/project.srcs/utils_1/imports/synth_1/system_bd_wrapper.dcp" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu48dr-ffvg1517-2-e -flow {Vivado Implementation 2022} -strategy "Performance_ExplorePostRoutePhysOpt" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
set_property -name "auto_rqs.directory" -value "/home/wirelesslab914/D:/temp/mobile-ch1_v1_4x2/project/project.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "/home/wirelesslab914/D:/Vivado/sounder_fr3_if_ddr4_4x2/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
