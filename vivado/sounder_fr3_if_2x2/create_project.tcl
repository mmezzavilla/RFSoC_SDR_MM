...
#
# Generated by Vivado on Sun Aug 25 16:21:37 EDT 2024
...
#
#    "/home/sharan/ali/sounder_rfsoc/vivado/Sounder_FR3_BW_Corr_mixer/Sounder_FR3_BW_Corr.srcs/constrs_1/new/constraints.xdc"
#    "/home/sharan/ali/sounder_rfsoc/vivado/Sounder_FR3_BW_Corr_mixer/Sounder_FR3_BW_Corr.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
set_property -name "riviera.compile.assertion_coverage" -value "0" -objects $obj
set_property -name "riviera.compile.basic_libraries" -value "1" -objects $obj
set_property -name "riviera.compile.branch_coverage" -value "0" -objects $obj
set_property -name "riviera.compile.ccomp.more_options" -value "" -objects $obj
set_property -name "riviera.compile.condition_coverage" -value "0" -objects $obj
set_property -name "riviera.compile.debug" -value "0" -objects $obj
set_property -name "riviera.compile.enable_atomic_expressions_in_the_conditional_statements" -value "0" -objects $obj
set_property -name "riviera.compile.enable_expressions_on_subprogram_arguments" -value "0" -objects $obj
set_property -name "riviera.compile.enable_fsm_sequences_in_fsm_coverage" -value "0" -objects $obj
set_property -name "riviera.compile.enable_the_expressions_consisting_of_one_variable_only" -value "0" -objects $obj
set_property -name "riviera.compile.enable_the_expressions_returning_vectors" -value "0" -objects $obj
set_property -name "riviera.compile.enable_the_expressions_with_relational_operators" -value "0" -objects $obj
set_property -name "riviera.compile.expression_coverage" -value "0" -objects $obj
set_property -name "riviera.compile.fsm_coverage" -value "0" -objects $obj
set_property -name "riviera.compile.load_glbl" -value "1" -objects $obj
set_property -name "riviera.compile.path_coverage" -value "0" -objects $obj
set_property -name "riviera.compile.statement_coverage" -value "0" -objects $obj
set_property -name "riviera.compile.sv_syntax" -value "2012" -objects $obj
set_property -name "riviera.compile.tcl.pre" -value "" -objects $obj
set_property -name "riviera.compile.vcom.more_options" -value "" -objects $obj
set_property -name "riviera.compile.vhdl_relax" -value "0" -objects $obj
set_property -name "riviera.compile.vhdl_syntax" -value "93" -objects $obj
set_property -name "riviera.compile.vlog.more_options" -value "" -objects $obj
set_property -name "riviera.compile.vlog_syntax" -value "2005" -objects $obj
set_property -name "riviera.elaborate.access" -value "0" -objects $obj
set_property -name "riviera.elaborate.unifast" -value "0" -objects $obj
set_property -name "riviera.simulate.asim.more_options" -value "" -objects $obj
set_property -name "riviera.simulate.assertion_coverage" -value "0" -objects $obj
set_property -name "riviera.simulate.branch_coverage" -value "0" -objects $obj
set_property -name "riviera.simulate.condition_coverage" -value "0" -objects $obj
set_property -name "riviera.simulate.custom_do" -value "" -objects $obj
set_property -name "riviera.simulate.custom_udo" -value "" -objects $obj
set_property -name "riviera.simulate.debug" -value "0" -objects $obj
set_property -name "riviera.simulate.expression_coverage" -value "0" -objects $obj
set_property -name "riviera.simulate.fsm_coverage" -value "0" -objects $obj
set_property -name "riviera.simulate.functional_coverage" -value "0" -objects $obj
set_property -name "riviera.simulate.log_all_signals" -value "0" -objects $obj
set_property -name "riviera.simulate.path_coverage" -value "0" -objects $obj
set_property -name "riviera.simulate.runtime" -value "1000ns" -objects $obj
set_property -name "riviera.simulate.saif" -value "" -objects $obj
set_property -name "riviera.simulate.saif_scope" -value "" -objects $obj
set_property -name "riviera.simulate.statement_coverage" -value "0" -objects $obj
set_property -name "riviera.simulate.tcl.post" -value "" -objects $obj
set_property -name "riviera.simulate.toggle_coverage" -value "0" -objects $obj
set_property -name "riviera.simulate.verilog_acceleration" -value "1" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Sounder_FR3_BW_Corr.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/Sounder_FR3_BW_Corr.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Sounder_FR3_BW_Corr.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
